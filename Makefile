...
elasticsearch-all-reindex: elasticsearch-delete-indices elasticsearch-mapping elasticsearch-ticket-reindex elasticsearch-portalfaq-reindex elasticsearch-portalservice-reindex ## Rebuild all on elasticsearch
